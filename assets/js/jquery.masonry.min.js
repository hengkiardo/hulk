...
/*!
   ...
   */
e.fn.imagesLoaded=function(n){var l=this,j=l.find("img").add(l.filter("img")),g=j.length,m="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==",i=[];
...
if(i){i.option(h||{});i._init();}else{e.data(this,"masonry",new e.Mason(h,this));}});}return this;};})(window,jQuery);