...
class Instagram_api {
    ...
    */
    function instagramLogin() {
     ...
     return 'https://api.instagram.com/oauth/authorize/?client_id=' . $this->codeigniter_instance->config->item('instagram_client_id') . '&redirect_uri=' . $this->codeigniter_instance->config->item('instagram_callback_url') .'&scope='.implode('+', $this->_scopes).'&response_type=code';
    ...
    */
    ...
    if($max == null) {
      $user_feed_request_url = "https://api.instagram.com/v1/users/self/feed?access_token=".$this->access_token;
    }else{
